                ...
                >
                    ...
                    >
                        ...
                        <div className="about-image-right">
                            <p>From its inception, <b className='about-compney-name'><b className='about-compney-name'>Real Estate Rocket</b></b> Solutions has given homeowners the option to sell their home in any circumstance or condition. All of our staff members are specialists in the field of home buying and selling, and our management team has years of industry expertise. Unlike many other businesses, <b className='about-compney-name'>Real Estate Rocket</b> </p>
                    ...
                    <motion.p
                        ...
                        whileInView="show"
                        viewport={{ once: true }}
                    >Another source of pride for <b className='about-compney-name'>Real Estate Rocket</b> Solutions is that we don't impose hidden costs; the quote we present is the amount of money you receive. <b className='about-compney-name'>Real Estate Rocket</b> Solutions does not charge a fee to our sellers and pays the closing costs for the property.</motion.p>
                </motion.div>
            </motion.div>
        </>
    )
